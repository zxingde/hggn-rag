...
class BERTInstruction(BaseInstruction):
    ...
    def __init__(self, args, word_embedding, num_word, model, constraint=False):
        ...
        if model == 'bert':
            ...
            self.tokenizer = AutoTokenizer.from_pretrained('/root/autodl-tmp/gnn-rag/GNN-RAG-main2/gnn/sbert', local_files_only=True)
            self.pretrained_weights = '/root/autodl-tmp/gnn-rag/GNN-RAG-main2/gnn/sbert'
